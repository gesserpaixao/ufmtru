...
<div class="box">
        ...
        <div class="box-body">
                ...
                <form method="POST" action="<?php echo e(route('relatorio/avaliar/busca')); ?>">
                    <?php echo csrf_field(); ?>
 ...
 <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
          ...
          <div class="info-box-content">
            ...
            <span class="info-box-number"><?php echo e($total_valor); ?></span>
          </div>
          <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td><?php echo e($Item->questao_01); ?></td>
                                <td><?php echo e($Item->questao_02); ?></td>
                                <td><?php echo e($Item->questao_03); ?></td>
                                <td><?php echo e($Item->questao_04); ?></td>
                                <td><?php echo e($Item->questao_05); ?></td>
